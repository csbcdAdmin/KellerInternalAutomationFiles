...
#------------------
#
# Patch Notes: Adding Calibration manipulation
#
#------------------
"""
...
def add_calibration(sensor_id, premultiplier, preoffset, multiplier, offset):
    """
...
meta_voltage_filename = os.path.join(path, "Voltage_meta.txt")
meta_current_filename = os.path.join(path, "Current_meta.txt")
tdms_voltage_filename = os.path.join(path, "Voltage.tdms")
tdms_current_filename = os.path.join(path, "Current.tdms")
