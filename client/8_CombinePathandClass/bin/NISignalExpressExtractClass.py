...
class NISignalExpressExtract:
    ...
    def __reshape(self, channel_names):
        input_file = open(self.__add_output_file_location(self._tdms_to_csv_filename), "r")
        output_filename = "output2.csv"
        output_file = open(self.__add_output_file_location(output_filename), "wb")
    ...
    def calibrate_output(self):
        ...
        input_file = open(self.__add_output_file_location(input_filename), "r")
